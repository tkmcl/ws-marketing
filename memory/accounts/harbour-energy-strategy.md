# Account Deep Dive: Harbour Energy (HBR.L)

## 1. Strategy & Priorities (2026+)
...
## 2. Asset Base & AIM Relevance

| Asset Hub | Status | Operator | AIM Relevance | Strategic Focus (2026+) |
| :--- | :--- | :--- | :--- | :--- |
| **Mexico (Zama)** | Growth | **Harbour (NEW)** | 🔴 **HIGH** | **Key Entry Hook**: Harbour recently took over operatorship from Pemex. 2026 is the peak FEED/Design phase ahead of FID. |
| **Norway (Dvalin Area)** | Growth | **Harbour (55%)** | 🔴 **HIGH** | Dvalin North first gas expected mid-2026. Drilling planning is active. |
| **Indonesia (Andaman II)** | Growth | **Harbour** | 🔴 **HIGH** | Planning for 2C resources (143 mmboe) is the core growth engine in Asia. |
| **UK (J-Area / Elgin)** | Harvest | **Harbour** | 🟡 **MEDIUM** | Focus on infill drilling and efficiency; high planning complexity. |
| **Norway (Maria Ph 2)** | Growth | Non-Op | 🟡 **MEDIUM** | Project completed; focus on tie-back optimization. |
| **CCS (Viking/Acorn)** | Transition | **Harbour** | 🟡 **MEDIUM** | Long-term strategic differentiator. |
| **UK (SNS)** | Harvest | **Harbour** | 🟢 **LOW** | Decommissioning planning. |

*Note: Harbour is exiting Natuna Sea/Tuna (Indonesia) in Q2 2026 to focus on higher-margin hubs.*

---

## 3. Competitive Tech Footprint
*   **Subsurface/Drilling**: SLB (FDplan) and Halliburton (360/Compass) are entrenched.
*   **The Planning Gap**: There is no unified strategic layer connecting the **Work Program & Budget (WP&B)** to the operational calendar. This silo is the primary barrier to hitting their $4-5B cost-reduction target.
